...
def test_lists():    
    ...
    # Note: max(list1) will not work because it is a composite list with objects of int and str.

    assert max(list2) == 7

    # Minimum value: Returns item from the list with min value.
    # Note: min(list1) will not work because it is a composite list with objects of int and str.
    ...
    assert list1.remove(2018) == None

    
    #Inserting object in the list at an offset:
    assert list1.insert(2, 2018) == None
...
def test_list_methods():
    ...
    assert fruits  == ['grapes', 'orange', 'apple', 'pear', 'banana', 'kiwi', 'apple']
...
def test_list_comprehensions():
    ...
    assert combination == [(1, 3), (1, 4), (1, 3), (2, 3), (2, 4), (2, 3), (3, 4)]

    #Another equivalent code snippet for the combinations above can be written as below:
    ...
    #As you can see the above list contains few duplicates, we can remove the duplicates using 
    ...
    assert squaring == [(0, 0), (1, 1), (2, 4), (3, 9), (4, 16), (5, 25), (6, 36), (7, 49), (8, 64), (9, 81)]
